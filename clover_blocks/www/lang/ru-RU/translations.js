...
const ruRu = {
    ...
    blocks: {
        ...
        scan_qr_data: 'распознование QR-кода',
        scan_qr_list_data: 'распознование нескольких QR-кодов',
        qr_to_position: 'конвертировать QR данные в позицию',
        extract: 'извлечь',
        from_topic: 'из топика',
        ...
        tooltip_scan_qr_list: 'Возвращает списком данные всех обнаруженных QR-кодов в течение таймаута.',
        tooltip_qr_to_position: 'Конвертирует данные QR-кода в координаты для полёта. Данные QR должны содержать координаты в формате "x,y,z" или "x,y".'
    }
};
